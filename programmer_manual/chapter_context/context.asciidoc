...
----
    ...
    */
    ...
    int declaring_template_type; //we are in identifier declaration
    c_template_parameter template_parameter; //we are in identifier declaration

    //useful in i_am_in_template_declaration = 2 and in template_instantiation
    t_vector_template_parameter vector_template_parameter;
    t_map_template_parameter map_template_parameter;

//    int template_instantiation;
